...
const POPULAR_DESTINATIONS = [
    ...
    },
    {
        id: "tirupati_temple",
        name: "Tirupati",
        description: "Famous temple city with Venkateswara Temple and spiritual significance",
        category: "religious places",
        source: "sample",
        latitude: 13.6288,
        longitude: 79.4192,
        ...
        highlights: ["Venkateswara Temple", "Spiritual Significance", "Pilgrimage", "Religious Experience"],
        budget: "₹1000-3000 per day",
        idealFor: ["Pilgrims", "Spiritual Seekers", "Devotees", "Families"],
        bestMonths: ["Oct", "Nov", "Dec", "Jan", "Feb", "Mar"],
        thingsToDo: ["Temple Visits", "Pilgrimage", "Spiritual Activities", "Religious Ceremonies"],
        travelTime: "2-3 hours from Chennai",
    ...
    },
    {
        id: "golden_temple",
        name: "Golden Temple",
        description: "Sacred Sikh shrine with golden dome and spiritual significance",
        category: "religious places",
        source: "sample",
        latitude: 31.6200,
        longitude: 74.8765,
        image: "https://images.unsplash.com/photo-1564507592333-c60657eea523?w=400",
        region: "Punjab",
        highlights: ["Golden Dome", "Sikh Shrine", "Spiritual Significance", "Community Kitchen"],
        budget: "₹1000-3000 per day",
        idealFor: ["Sikh Devotees", "Spiritual Seekers", "Pilgrims", "Families"],
        bestMonths: ["Oct", "Nov", "Dec", "Jan", "Feb", "Mar"],
        thingsToDo: ["Temple Visits", "Community Kitchen", "Spiritual Activities", "Religious Ceremonies"],
        travelTime: "30 minutes from Amritsar city center",
    ...
    },
    {
        id: "ajmer_sharif",
        name: "Ajmer Sharif",
        description: "Famous Sufi shrine with spiritual significance and religious importance",
        category: "religious places",
        source: "sample",
        latitude: 26.4499,
        longitude: 74.6399,
        image: "https://images.unsplash.com/photo-1564507592333-c60657eea523?w=400",
        region: "Rajasthan",
        highlights: ["Sufi Shrine", "Spiritual Significance", "Religious Importance", "Pilgrimage"],
        budget: "₹1500-4000 per day",
        idealFor: ["Sufi Devotees", "Spiritual Seekers", "Pilgrims", "Religious Enthusiasts"],
        bestMonths: ["Oct", "Nov", "Dec", "Jan", "Feb", "Mar"],
        thingsToDo: ["Shrine Visits", "Spiritual Activities", "Religious Ceremonies", "Pilgrimage"],
        travelTime: "2-3 hours from Jaipur",
        wikipediaUrl: "https://en.wikipedia.org/wiki/Ajmer_Sharif",
        visitorsPerYear: "1-2 million"
    },
    {
        id: "bodh_gaya",
        name: "Bodh Gaya",
        description: "Buddhist pilgrimage site where Buddha attained enlightenment",
        category: "religious places",
        source: "sample",
        latitude: 24.6961,
        longitude: 84.9914,
        image: "https://images.unsplash.com/photo-1564507592333-c60657eea523?w=400",
        region: "Bihar",
        highlights: ["Buddhist Pilgrimage", "Enlightenment Site", "Spiritual Significance", "Temples"],
        budget: "₹1000-3000 per day",
        idealFor: ["Buddhist Devotees", "Spiritual Seekers", "Pilgrims", "Meditation Enthusiasts"],
        bestMonths: ["Oct", "Nov", "Dec", "Jan", "Feb", "Mar"],
        thingsToDo: ["Temple Visits", "Meditation", "Spiritual Activities", "Pilgrimage"],
        travelTime: "2-3 hours from Patna",
    ...
    },
    {
        ...
        image: "https://images.unsplash.com/photo-1564507592333-c60657eea523?w=400",
        region: "Uttar Pradesh",
        highlights: ["Buddhist Pilgrimage", "First Sermon Site", "Spiritual Significance", "Stupas"],
        budget: "₹1000-3000 per day",
        idealFor: ["Buddhist Devotees", "Spiritual Seekers", "Pilgrims", "History Enthusiasts"],
        bestMonths: ["Oct", "Nov", "Dec", "Jan", "Feb", "Mar"],
        thingsToDo: ["Stupa Visits", "Meditation", "Spiritual Activities", "Historical Tours"],
        travelTime: "1-2 hours from Varanasi",
        wikipediaUrl: "https://en.wikipedia.org/wiki/Sarnath",
        visitorsPerYear: "500K-1M"
    },
    {
        id: "shirdi_sai_baba",
        name: "Shirdi",
        description: "Famous temple town with Sai Baba temple and spiritual significance",
        category: "religious places",
        source: "sample",
        latitude: 19.7596,
        longitude: 74.4770,
        image: "https://images.unsplash.com/photo-1564507592333-c60657eea523?w=400",
        region: "Maharashtra",
        highlights: ["Sai Baba Temple", "Spiritual Significance", "Pilgrimage", "Religious Experience"],
        budget: "₹1000-3000 per day",
        idealFor: ["Sai Baba Devotees", "Spiritual Seekers", "Pilgrims", "Families"],
        bestMonths: ["Oct", "Nov", "Dec", "Jan", "Feb", "Mar"],
        thingsToDo: ["Temple Visits", "Spiritual Activities", "Religious Ceremonies", "Pilgrimage"],
    ...
    },
    {
        id: "haridwar",
        name: "Haridwar",
        description: "Sacred city on the Ganges with temples and spiritual significance",
        category: "religious places",
        source: "sample",
        latitude: 29.9457,
        longitude: 78.1642,
        image: "https://images.unsplash.com/photo-1564507592333-c60657eea523?w=400",
        region: "Uttarakhand",
        highlights: ["Ganges Ghats", "Temples", "Spiritual Significance", "Kumbh Mela"],
        budget: "₹1500-4000 per day",
        idealFor: ["Hindu Devotees", "Spiritual Seekers", "Pilgrims", "Families"],
        bestMonths: ["Oct", "Nov", "Dec", "Jan", "Feb", "Mar"],
        thingsToDo: ["Ghat Visits", "Temple Tours", "Spiritual Activities", "Religious Ceremonies"],
        travelTime: "6-7 hours from Delhi",
        wikipediaUrl: "https://en.wikipedia.org/wiki/Haridwar",
        visitorsPerYear: "1-2 million"
    },
    {
        id: "kerala_hill_stations",
        name: "Munnar",
        description: "Tea gardens and hill station in the Western Ghats",
        category: "hill stations",
        source: "sample",
        latitude: 10.0889,
        longitude: 77.0595,
        ...
        bestMonths: ["Oct", "Nov", "Dec", "Jan", "Feb", "Mar"],
        thingsToDo: ["Tea Plantation Tour", "Wildlife Safari", "Trekking", "Waterfall Visit"],
    ...
    },
    {
        ...
        image: "https://images.unsplash.com/photo-1564507592333-c60657eea523?w=400",
        region: "Karnataka",
        highlights: ["UNESCO Heritage", "Ancient Ruins", "Temples", "Architecture"],
        budget: "₹1500-4000 per day",
        idealFor: ["History Lovers", "Archaeology Enthusiasts", "Photographers", "Culture Lovers"],
        bestMonths: ["Oct", "Nov", "Dec", "Jan", "Feb", "Mar"],
    ...
    },
    {
        ...
        thingsToDo: ["Monastery Visits", "Trekking", "River Rafting", "Photography"],
    ...
    },
    {
        id: "spiti_valley",
        name: "Spiti Valley",
        description: "High-altitude desert valley with monasteries and adventure activities",
        category: "adventure spots",
        source: "sample",
        latitude: 32.2432,
        longitude: 78.1892,
        ...
        highlights: ["High Altitude", "Monasteries", "Desert Landscapes", "Adventure Sports"],
        budget: "₹2500-6000 per day",
    ...
    },
    {
        ...
        travelTime: "8-10 hours from Delhi",
        wikipediaUrl: "https://en.wikipedia.org/wiki/Manali",
        visitorsPerYear: "2-3 million"
    },
    {
        id: "coorg_adventure",
        ...
        wikipediaUrl: "https://en.wikipedia.org/wiki/Coorg",
        visitorsPerYear: "1-2 million"
    },
    {
        id: "munnar_adventure",
        name: "Munnar Adventure",
    ...
    },
    {
        ...
        wikipediaUrl: "https://en.wikipedia.org/wiki/Andaman_Islands",
        visitorsPerYear: "1-2 million"
    },
    {
    ...
    },
    {
        ...
        wikipediaUrl: "https://en.wikipedia.org/wiki/Pondicherry",
        visitorsPerYear: "1-2 million"
    },
    {
        id: "kovalam_beach",
    ...
    },
    {
        ...
        travelTime: "6-7 hours from Bangalore",
        wikipediaUrl: "https://en.wikipedia.org/wiki/Gokarna",
        visitorsPerYear: "500K-1M"
    },
    {
        id: "digha_beach",
    ...
    },
    {
        id: "mysore_palace",
        name: "Mysore",
        description: "City of Palaces with royal grandeur and cultural heritage",
        category: "historical places",
        source: "sample",
        latitude: 12.2958,
        longitude: 76.6394,
        image: "https://images.unsplash.com/photo-1564507592333-c60657eea523?w=400",
        region: "Karnataka",
        highlights: ["Mysore Palace", "Chamundi Hills", "Cultural Heritage", "Royal Architecture"],
        budget: "₹2000-5000 per day",
        idealFor: ["History Lovers", "Culture Enthusiasts", "Families", "Photographers"],
        bestMonths: ["Oct", "Nov", "Dec", "Jan", "Feb", "Mar"],
        thingsToDo: ["Palace Tours", "Temple Visits", "Cultural Shows", "Shopping"],
    ...
    },
    {
        id: "fatehpur_sikri",
        name: "Fatehpur Sikri",
        description: "UNESCO World Heritage site with Mughal architecture and historical significance",
        category: "historical places",
        source: "sample",
        latitude: 27.0937,
        longitude: 77.6603,
        image: "https://images.unsplash.com/photo-1564507592333-c60657eea523?w=400",
        region: "Uttar Pradesh",
        highlights: ["UNESCO Heritage", "Mughal Architecture", "Buland Darwaza", "Historical Significance"],
        budget: "₹1000-3000 per day",
        idealFor: ["History Lovers", "Architecture Enthusiasts", "Photographers", "Culture Lovers"],
        bestMonths: ["Oct", "Nov", "Dec", "Jan", "Feb", "Mar"],
        thingsToDo: ["Palace Tours", "Architecture Photography", "Historical Walks", "Temple Visits"],
        travelTime: "1-2 hours from Agra",
    ...
    },
    {
        ...
        name: "Khajuraho",
        description: "UNESCO World Heritage site with ancient temples and intricate carvings",
        category: "historical places",
        source: "sample",
        latitude: 24.8529,
        longitude: 79.9334,
        ...
        highlights: ["UNESCO Heritage", "Ancient Temples", "Intricate Carvings", "Architecture"],
        budget: "₹1500-4000 per day",
        idealFor: ["History Lovers", "Architecture Enthusiasts", "Photographers", "Culture Lovers"],
        bestMonths: ["Oct", "Nov", "Dec", "Jan", "Feb", "Mar"],
        thingsToDo: ["Temple Tours", "Architecture Photography", "Cultural Shows", "Historical Walks"],
        travelTime: "5-6 hours from Delhi",
    ...
    },
    {
        ...
        description: "UNESCO World Heritage sites with ancient rock-cut caves and Buddhist art",
        category: "historical places",
        source: "sample",
        latitude: 20.5523,
        longitude: 75.7004,
        image: "https://images.unsplash.com/photo-1564507592333-c60657eea523?w=400",
        region: "Maharashtra",
        highlights: ["UNESCO Heritage", "Rock-cut Caves", "Buddhist Art", "Ancient Architecture"],
        budget: "₹1500-4000 per day",
        idealFor: ["History Lovers", "Art Enthusiasts", "Photographers", "Spiritual Seekers"],
        bestMonths: ["Oct", "Nov", "Dec", "Jan", "Feb", "Mar"],
        thingsToDo: ["Cave Tours", "Art Photography", "Historical Walks", "Temple Visits"],
        travelTime: "4-5 hours from Aurangabad",
    ...
    },
    {
        ...
        description: "UNESCO World Heritage site with magnificent sun temple architecture",
        category: "historical places",
        source: "sample",
        latitude: 19.8876,
        longitude: 86.0946,
        image: "https://images.unsplash.com/photo-1564507592333-c60657eea523?w=400",
        region: "Odisha",
        highlights: ["UNESCO Heritage", "Sun Temple", "Architecture", "Historical Significance"],
        budget: "₹1000-3000 per day",
        idealFor: ["History Lovers", "Architecture Enthusiasts", "Photographers", "Culture Lovers"],
        bestMonths: ["Oct", "Nov", "Dec", "Jan", "Feb", "Mar"],
        thingsToDo: ["Temple Tours", "Architecture Photography", "Historical Walks", "Cultural Shows"],
        travelTime: "1-2 hours from Puri",
    ...
    },
    {
        id: "red_fort_delhi",
        name: "Red Fort Delhi",
        description: "UNESCO World Heritage site and symbol of Mughal power in Delhi",
        category: "historical places",
        source: "sample",
        latitude: 28.6562,
        longitude: 77.2410,
        image: "https://images.unsplash.com/photo-1564507592333-c60657eea523?w=400",
        region: "Delhi",
        highlights: ["UNESCO Heritage", "Mughal Architecture", "Historical Significance", "Museum"],
        budget: "₹500-1500 per day",
        idealFor: ["History Lovers", "Culture Enthusiasts", "Families", "Photographers"],
        bestMonths: ["Oct", "Nov", "Dec", "Jan", "Feb", "Mar"],
        thingsToDo: ["Fort Tours", "Museum Visit", "Photography", "Historical Walks"],
        travelTime: "30 minutes from Delhi city center",
    ...
    },
    {
        id: "qutub_minar",
        name: "Qutub Minar",
        description: "UNESCO World Heritage site with tallest brick minaret in the world",
        category: "historical places",
        source: "sample",
        latitude: 28.5244,
        longitude: 77.1855,
        image: "https://images.unsplash.com/photo-1564507592333-c60657eea523?w=400",
        region: "Delhi",
        highlights: ["UNESCO Heritage", "Tallest Minaret", "Mughal Architecture", "Historical Significance"],
        budget: "₹500-1500 per day",
        idealFor: ["History Lovers", "Architecture Enthusiasts", "Photographers", "Culture Lovers"],
        bestMonths: ["Oct", "Nov", "Dec", "Jan", "Feb", "Mar"],
        thingsToDo: ["Minaret Tours", "Architecture Photography", "Historical Walks", "Museum Visit"],
        travelTime: "45 minutes from Delhi city center",
    ...
    },
    {
        ...
        name: "Charminar",
        description: "Iconic monument and symbol of Hyderabad with four minarets",
        category: "historical places",
        source: "sample",
        latitude: 17.3616,
        longitude: 78.4747,
        image: "https://images.unsplash.com/photo-1564507592333-c60657eea523?w=400",
        region: "Telangana",
        highlights: ["Iconic Monument", "Four Minarets", "Historical Significance", "Local Culture"],
        budget: "₹1000-3000 per day",
        idealFor: ["History Lovers", "Culture Enthusiasts", "Photographers", "Families"],
        bestMonths: ["Oct", "Nov", "Dec", "Jan", "Feb", "Mar"],
        thingsToDo: ["Monument Tours", "Photography", "Local Shopping", "Cultural Walks"],
        travelTime: "30 minutes from Hyderabad city center",
    ...
    },
    {
        id: "darjeeling_hills",
        name: "Darjeeling",
        description: "Famous hill station with tea gardens and Himalayan views",
        category: "hill stations",
        source: "sample",
        latitude: 27.0360,
        longitude: 88.2627,
    ...
    },
    {
        ...
        bestMonths: ["Mar", "Apr", "May", "Sep", "Oct", "Nov"],
        thingsToDo: ["Mall Road Walk", "Toy Train Ride", "Temple Visits", "Shopping"],
    ...
    },
    {
        ...
        bestMonths: ["Apr", "May", "Jun", "Sep", "Oct", "Nov"],
        thingsToDo: ["Skiing", "Trekking", "Hot Springs", "Temple Visits"],
        travelTime: "8-10 hours from Delhi",
        wikipediaUrl: "https://en.wikipedia.org/wiki/Manali",
        visitorsPerYear: "2-3 million"
    },
    {
        id: "ooty_hills",
        name: "Ooty",
        description: "Queen of Nilgiris with tea gardens and botanical gardens",
        category: "hill stations",
        source: "sample",
        latitude: 11.4102,
        longitude: 76.6950,
        ...
        bestMonths: ["Mar", "Apr", "May", "Sep", "Oct", "Nov"],
        thingsToDo: ["Tea Garden Tour", "Botanical Garden", "Toy Train", "Lake Boating"],
        travelTime: "6-7 hours from Bangalore",
    ...
    },
    {
        ...
        image: "https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=400",
        region: "Tamil Nadu",
        highlights: ["Kodaikanal Lake", "Misty Mountains", "Waterfalls", "Trekking"],
        budget: "₹2000-5000 per day",
        idealFor: ["Couples", "Families", "Nature Lovers", "Adventure Seekers"],
        bestMonths: ["Mar", "Apr", "May", "Sep", "Oct", "Nov"],
        thingsToDo: ["Lake Boating", "Waterfall Visits", "Trekking", "Photography"],
        travelTime: "6-7 hours from Madurai",
        wikipediaUrl: "https://en.wikipedia.org/wiki/Kodaikanal",
        visitorsPerYear: "1-2 million"
    },
    {
        ...
        bestMonths: ["Oct", "Nov", "Dec", "Jan", "Feb", "Mar"],
        thingsToDo: ["Coffee Plantation Tour", "Trekking", "Waterfall Visits", "Adventure Sports"],
        travelTime: "5-6 hours from Bangalore",
        wikipediaUrl: "https://en.wikipedia.org/wiki/Coorg",
        visitorsPerYear: "1-2 million"
    },
    {
        id: "mussoorie_hills",
        name: "Mussoorie",
        description: "Queen of Mountains with panoramic views and colonial charm",
        category: "hill stations",
        source: "sample",
        latitude: 30.4598,
        longitude: 78.0644,
        image: "https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=400",
        region: "Uttarakhand",
        highlights: ["Panoramic Views", "Colonial Architecture", "Cable Car", "Waterfalls"],
        budget: "₹2000-5000 per day",
        idealFor: ["Families", "Couples", "Nature Lovers", "Photographers"],
        bestMonths: ["Mar", "Apr", "May", "Sep", "Oct", "Nov"],
        thingsToDo: ["Cable Car Ride", "Waterfall Visits", "Mall Road Walk", "Photography"],
        travelTime: "6-7 hours from Delhi",
    ...
    },
    {
        id: "nainital_hills",
        name: "Nainital",
        description: "Lake city with beautiful Naini Lake and surrounding hills",
        category: "hill stations",
        source: "sample",
        latitude: 29.3919,
        longitude: 79.4542,
        image: "https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=400",
        region: "Uttarakhand",
        highlights: ["Naini Lake", "Boat Rides", "Mountain Views", "Temples"],
        budget: "₹2000-5000 per day",
        idealFor: ["Families", "Couples", "Nature Lovers", "Adventure Seekers"],
        bestMonths: ["Mar", "Apr", "May", "Sep", "Oct", "Nov"],
        thingsToDo: ["Lake Boating", "Temple Visits", "Trekking", "Photography"],
        travelTime: "6-7 hours from Delhi",
